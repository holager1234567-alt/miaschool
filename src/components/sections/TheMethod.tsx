...
export function TheMethod() {
  ...
  return (
    <section ref={ref} className="bg-white px-4 pt-2 pb-10 text-[#1c2d2b] sm:px-6 sm:pb-12 md:pb-14">
      <div className="container-page mx-auto max-w-3xl text-center">
        <h2
          data-method-fade
          className="method-title heading-section font-hero mx-auto mb-6 max-w-none sm:mb-8"
        >
